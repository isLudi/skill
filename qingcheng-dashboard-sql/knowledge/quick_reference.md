...
| 青橙 TMK 潜客转正常线索、承接顾问与订单追踪 | `knowledge/dashboards/qingcheng_tmk_transfer_order_trace_template.md` | `knowledge/metrics/qingcheng_tmk_transfer_order_trace_metrics.md`、两个已确认转移 Join 契约；延迟排查看观测台账 | 订单必须关联转移后的正常 lead_id；成交状态用“是/否/业财未回补”三态，未回补金额保持空 |
