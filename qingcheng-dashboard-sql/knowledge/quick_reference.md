...
| 青橙退费原因、原因金额结构、退费人头明细 | `knowledge/dashboards/qingcheng_refund_reason_analysis_template.md` | `knowledge/metrics/qingcheng_refund_reason_metrics.md`、`knowledge/tables/finance_dw.dwd_finance_order_refund_df.md` | 原因金额按订单退款重新分摊；退款类型、分摊权重、渠道 CASE 和结果期次架构仍待确认 |
