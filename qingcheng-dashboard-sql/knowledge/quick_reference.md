...
| 个人/团队完成度与订单流水不一致 | `knowledge/sql_patterns/qingcheng_template_dashboard_amount_reconciliation_20260805.md`、`knowledge/sql_patterns/qingcheng_completion_sql_repair_checklist.md` | `knowledge/sql_patterns/qingcheng_personal_completion_discounted_output_risks.md`、`knowledge/dashboards/qingcheng_personal_conversion_raw_20260522.md`、`knowledge/metrics/qingcheng_personal_conversion_metrics.md`、`knowledge/tables/finance_dw.app_finance_performance_extend_details_hf.md` | 不要只看前端公式；先统一员工/团队范围、期次、试听过滤和 `income_all/refund_all`，再查 service transfer、finance 补缺去重、渠道 ld 唯一性和期次架构 join |
...
| `finance_dw.app_finance_performance_extend_details_hf` | 课程转移缺失补充、调课链路、退 4/点睛退 2 规则 | 先按业务键去重；不直接替代 service 的 `income_all/refund_all` |
