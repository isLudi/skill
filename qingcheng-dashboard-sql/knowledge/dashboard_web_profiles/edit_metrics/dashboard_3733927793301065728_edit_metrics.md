# 过程数据报表-青橙 edit-page metrics profile

## Snapshot

- generated_at: `2026-06-24 18:49:49`
...
- rendered dashboard profile: [view profile](../qingcheng_process_data_report_web_profile.md)
- runtime JSON: `C:\Users\Ludim\.codex\runtime\usql-web-query-operator\artifacts\20260624-184938\dashboard_3733927793301065728_edit_metrics_profile.json`
...
|---|---:|---|---|---:|---:|
| `渠道-整体` | 2064 | `青橙-过程数据` | channel_map_1, dept_2 | 17 | 14 |
| `渠道-年级` | 2064 | `青橙-过程数据` | channel_map_1, grade_1 | 17 | 14 |
| `渠道-主管` | 2064 | `青橙-过程数据` | channel_map_1, grade_1, xiaozu, department | 17 | 14 |
| `二级-整体` | 2064 | `青橙-过程数据` | channel_map_2, dept_2 | 17 | 14 |
| `二级-年级` | 2064 | `青橙-过程数据` | channel_map_2, grade_1 | 17 | 14 |
| `二级-主管` | 2064 | `青橙-过程数据` | channel_map_2, grade_1, xiaozu | 17 | 14 |
| `伙伴数据` | 2064 | `青橙-过程数据` | channel_map_1, xiaozu, employee_email_name, grade_1, channel_map_2 | 17 | 14 |
