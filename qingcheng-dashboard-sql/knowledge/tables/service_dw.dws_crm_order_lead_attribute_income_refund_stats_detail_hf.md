...
| `transfer_in_amount` | bigint | 调入金额（分） | 转化 raw 用于排除 service 内部调课调班金额；2026-07-03 起也作为个人/团队完成度内部调课调班补充识别信号 |
| `transfer_out_amount` | bigint | 调出金额（分） | 转化 raw 用于排除 service 内部调课调班金额；2026-07-03 起也作为个人/团队完成度内部调课调班补充识别信号 |
