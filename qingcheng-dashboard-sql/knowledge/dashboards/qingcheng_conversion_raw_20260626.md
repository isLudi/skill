...
入库时间：2026-06-26；当前热修版本：2026-07-29
...
- 2026-07-29 校准暑期运营周期为 `0710=07-07~07-13`、`0716=07-14~07-19`、`0722=07-20~07-25`、`0728=07-26~07-31`、`0803=08-01~08-06`、`0809=08-07~08-12`，并将 `IP退费 / 春春、朱博士、郭艺` 精确渠道规则同步到 `lead_map` 与 `normal_bb`。
...
- 周一归上一周周五期次。
- 周二到周日归当前周周五期次。
- `biz_qici_calendar` 是暑期业务日历修正窗口，当前覆盖 `20260710期`、`20260716期`、`20260722期`、`20260728期`、`20260803期`、`20260809期`。
