...
| CTE | 用途 | 关键字段 |
|---|---|---|
| `dd` | 订单业绩明细，补充青橙渠道和年级，计算收入、退款、净营收、交易期次 | `lead_id`, `original_order_user_number`, `performance_employee_email_name`, `income_amount`, `refund_amount`, `promit_amount`, `qici`, `rule_name`, `grade_0` |
