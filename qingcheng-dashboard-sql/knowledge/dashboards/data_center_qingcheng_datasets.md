...
| 2 | `转化数据` | `待补充` | `2460` | `待补充` | `待补充` | 青橙项目部 / 转化数据看板使用的 2460 数据集；本次回写未重新抓取数据中心详情元数据 | [data_center_qingcheng_2460_20260626.sql](../../resources/raw_sql/data_center_qingcheng_2460_20260626.sql) | 462 |
