...
```
Ask Codex to use the `validate-data` skill, then provide the analysis, SQL, chart, report, or result set to review.
```
...
```
Please use the validate-data skill to review this quarterly revenue analysis before I send it to the exec team: [analysis]
```

```
Please use the validate-data skill to check my churn analysis. I'm comparing Q4 churn rates to Q3, but Q4 has a shorter measurement window.
```

```
Please use the validate-data skill to review this SQL query and its results for our conversion funnel. Does the logic look right? [query + results]
```

## Tips

- Use this skill before any high-stakes presentation or decision
