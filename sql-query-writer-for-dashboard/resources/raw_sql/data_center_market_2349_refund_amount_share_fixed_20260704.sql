...
select
    ...
    if(fg.total_refund_amount = 0, 0, coalesce(sr.refund_amount, 0) / fg.total_refund_amount) as refund_amount_ratio
...
select
    ...
    fg.total_refund_amount,
    if(fg.total_refund_amount = 0, 0, coalesce(pr.refund_amount, 0) / fg.total_refund_amount) as refund_amount_ratio
from filter_group_with_grade fg
...
select
    ...
    fg.total_refund_amount,
    if(fg.total_refund_amount = 0, 0, coalesce(gr.refund_amount, 0) / fg.total_refund_amount) as refund_amount_ratio
