...
when lf.flow_pool_name like '%星义大大%' then '赵星义'
when lf.third_department_name='图书营销部' and (lf.sku_id_name like '%孟亚飞99%' or lf.sku_id_name like '%亚飞%') then '孟亚飞99-2组'
...
when lf.put_plan_name like '%周司鹏%' then '品宣组KOC'
when lf.put_plan_name like '%公导私%' and lf.put_plan_name like '%未购课%' then '公导私报名失败'
when lf.third_department_name = '图书营销部' and lf.rule_name like '%点睛卷%' then '押题卷'
...
when (lf.flow_pool_name like '%北大汤哥%' or lf.flow_pool_name like '%海淀名师高阶%') and lf.sku_id_name like '%小艺%' then '郭艺'
...
when lf.rule_name like '%99元智学%' then 'AI直播'
when lf.channel_provider_name = '宿迁伯岳' then '小程序'
...
when lf.put_plan_name like '%qq0元%' and lf.third_department_name = '线上商务部' then '创新QQ'
...
when lf.channel_name_1 = '商务' and lf.channel_name_2 = '短信' then '短信'
when lf.ad_account_name like '%肖晗%' and lf.channel_name_1 = '信息流' then '信息流-肖晗'
...
when (lf.flow_pool_name like '%马总%' or lf.flow_pool_name = '减法化学马老师' or lf.flow_pool_name like '%总裁讲化学%' or lf.flow_pool_name like '%高分讲堂%') and lf.lf_period_name not like '%多学科拓展%' and lf.sku_id_name like '%99%' and lf.third_department_name='直播部' then '马凯鹏99'
when (lf.flow_pool_name like '%马总%' or lf.flow_pool_name = '减法化学马老师' or lf.flow_pool_name like '%总裁讲化学%' or lf.flow_pool_name like '%高分讲堂%') and lf.lf_period_name not like '%多学科拓展%' and lf.sku_id_name not like '%99%' and lf.third_department_name='直播部' then '马凯鹏29'
when (lf.flow_pool_name like '%北大杰哥%' or lf.flow_pool_name like '%张小杰%') and lf.lf_period_name not like '%多学科拓展%' and lf.third_department_name='直播部' then '张杰'
when lf.flow_pool_name like '%教育规划%' and lf.rule_name like '%张杰%' and lf.third_department_name='直播部' then '张杰'
when lf.source_manager_name = '陈晓菁04' and lf.channel_provider_name not like '%开拓%' and lf.put_plan_name not like '%九学%' then '商务低价'
when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%') and lf.lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.rule_name like '%99%' then '孟亚飞99-1组'
when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%') and lf.lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.channel_name_2 = '百度' then '孟亚飞百度数字人'
...
when lf.flow_pool_name = '正价课判单补录' then '正价课判单补录'
when lf.channel_name_1 = '转介绍' then '转介绍'
...
when lf.third_department_name = '私域运营部' and lf.channel_name_1 = '信息流获客' then '市场私域小红书'
when lf.channel_name_2 in ('APP','M站','PC') and lf.flow_pool_name not like '%途途%' then 'APP'
when lf.source_manager_name in ('高文羽') and lf.lead_purchase_intention_name = 'AI定制' then '人工外呼-AI'
...
when lf.source_manager_name in ('高文羽') and lf.channel_provider_name not like '%唐山TMK%' and lf.channel_provider_name like '%郑州%' then '郑州TMK-2组'
when lf.source_manager_name = '冯银晨' and lf.channel_name_2 = '小红书' then '信息流-小红书'
when lf.channel_name_1 = '信息流获客' and lf.flow_original_order_activity_price like '%1990%' then '信息流19'
...
when lf.channel_name_1 = '短直电商' and lf.channel_name_2 = 'B站' and lf.third_department_name like '%商务%' and lf.sku_id_name like '%陈瑞春%' and lf.flow_pool_name like '%自然流%' then 'B站信息流-陈瑞春'
when lf.channel_name_1 = '短直电商' and lf.channel_name_2 = 'B站' and lf.third_department_name like '%商务%' and lf.sku_id_name like '%朱博士%' and lf.flow_pool_name like '%自然流%' then 'B站信息流-朱汉祺'
...
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and (lf.sku_id_name like '%原型题%') then 'KOC-书课包'
...
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and (lf.sku_id_name like '%孟帝%' or lf.sku_id_name like '%dudu%' or lf.sku_id_name like '%市场初二%' or lf.rule_name like '%亚飞%' or lf.sku_id_name like '%初二高阳%' or lf.sku_id_name like '%高阳初二%' or lf.sku_id_name like '%精品初二%' or lf.sku_id_name like '%菁英初三%' or (lf.virtual_second_department_name = '菁英班学部' and lf.lead_purchase_intention_level2_category_name='初级' and lf.lead_create_time>= '2026-04-15 00:00:00')) then 'KOC-孟亚飞数学'
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and (lf.sku_id_name like '%帅师%' or lf.rule_name like '%周帅%') then 'KOC-周帅数学'
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and (lf.sku_id_name like '%肖晗%' or lf.rule_name like '%肖晗%') then 'KOC-肖晗'
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.lf_period_name not like '%多学科拓展%' and (lf.flow_original_order_activity_price like '%1100%' or lf.flow_original_order_activity_price like '%500%' or lf.flow_orders_income_amount like '%500%') and (lf.sku_id_name like '%朱汉祺%' or lf.sku_id_name like '%朱博士%' or lf.rule_name like '%朱汉祺5元%' or lf.sku_id_name like '%koc5元-朱博士%' or lf.rule_name like '%朱汉祺%') then 'KOC-5元朱汉祺'
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and (lf.sku_id_name like '%朱汉祺%' or lf.sku_id_name like '%29元%' or lf.sku_id_name like '%朱博士%' or lf.rule_name like '%朱汉祺%' or lf.rule_name like '%朱博士%' ) and (lf.flow_original_order_activity_price not like '%1100%' or lf.rule_name like '%29%') and lf.sku_id_name not like '%周帅%' then 'KOC-5元朱汉祺'
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.lf_period_name not like '%多学科拓展%' and lf.sku_id_name not like '%朱汉祺%' and lf.sku_id_name not like '%朱博士%' and lf.sku_id_name not like '%周帅%' and lf.sku_id_name not like '%29元%' then 'KOC-5元纯课'
when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.sku_id_name like '%周帅%' then 'KOC-周帅'
...
when lf.flow_pool_name like '%青岛寻知%' or lf.flow_pool_name like '%禾兴信息%' then '商务0元'
when lf.put_plan_name like '%益企发1元%' or lf.put_plan_name like '%腾瑞教育1元%' then '进校APP合作'
when lf.put_plan_name like '%外部图书供量%' or lf.flow_pool_name='高途旗舰店—线索—yuxinru' then '外部图书慧敏'
...
when lf.channel_provider_name like '%唐成刚%' or lf.flow_pool_name = '高途云集图书专营店-自然流' then '图书唐成刚'
when lf.channel_second_provider_name like '%沃德丰店铺线索赠课%' or lf.channel_second_provider_name like '%智慧城-图书%' or lf.put_plan_name like '%育甲%' then '外部图书慧敏'
when lf.flow_pool_name like '%高途图书产品学部%' then '图书任炯旭'
when lf.source_manager_name in ('王春宵') then '武汉图书直播间'
when lf.source_manager_name in ('高曼曼01','杨思怡','宋向函') then '图书KOC达人'
when lf.flow_pool_name like '%高中视频书%' or lf.flow_pool_name like '%高中教辅书%' or lf.flow_pool_name like '%朵拉老师%' then '北京图书直播间'
...
when lf.source_manager_name in ('方宇02','李月林') then '菁英市场流量'
when lf.channel_name_2 = '公众号' then '公众号'
...
when lf.third_department_name = '直播部' and lf.sku_id_name like '%周帅%' and lf.channel_name_2 in ('百度','B站') then '周帅-百度数字人'
when lf.third_department_name = '直播部' and lf.sku_id_name like '%孟亚飞%' and lf.sku_id_name like '%199%' then '孟亚飞199'
...
when lf.source_manager_name in ('陈甜06','梁晓敏') then '图书挂车'
when lf.flow_pool_name like '%天津智慧双子%' then '创新社群'
when lf.third_department_name like '%城市定制%' then '点睛卷'
when lf.first_department_name like '%KM%' and lf.flow_pool_name not like '%天津智慧双子%' then '途途商务'
...
when lf.flow_pool_name like '%自然流%' and lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.sku_id_name like '%周帅%' then 'KOC-周帅'
when lf.flow_pool_name like '%自然流%' and lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.sku_id_name like '%肖晗%' then 'KOC-肖晗'
when lf.flow_pool_name like '%自然流%' and lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.sku_id_name like '%朱汉祺%' and lf.flow_original_order_activity_price like '%1100%' then 'KOC-5元朱汉祺'
when lf.flow_pool_name like '%自然流%' and lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪') and lf.sku_id_name like '%朱汉祺%' and lf.flow_original_order_activity_price not like '%1100%' then 'KOC-朱汉祺29'
...
when lf.second_department_name = '市场二部' and lf.get_customer_way_name = 'KOL直播' then '市场二部KOC'
...
when lf.put_plan_name like '%高三复读%' then '市场私域高三复读'
when lf.put_plan_name ='美玲测试' then '途途信息流私信'
when lf.rule_name like '%训练营%' and lf.rule_name like '%市场私域%' then '市场私域入群'
when lf.flow_pool_name like '%青少-私域%' then '青少私域'
when lf.first_department_name = 'TT业务线' and lf.third_department_name like '%商务招生%' then '途途商务'
when lf.second_department_name = '战略客户部' then '文旅进校'
...
,case
    ...
    then date_format(date_trunc('week', date_parse(concat('2025', substr(rr.group_period_term, 1, 4)), '%Y%m%d') - interval '1' day) + interval '4' day,'%Y%m%d') || '期'
    else date_format(date_trunc('week', date_parse(concat('2026', substr(rr.group_period_term, 1, 4)), '%Y%m%d') - interval '1' day) + interval '4' day,'%Y%m%d') || '期'
