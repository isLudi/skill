...
when third_department_name in ('直播部','新媒体内容运营部','市场一组') and put_plan_name like '%退%' and flow_pool_name ='电商退款用户池'  then 'IP-退款订单复用'
when third_department_name in ('直播部','新媒体内容运营部','市场一组') and put_plan_name like '%失败%' and flow_pool_name ='电商退款用户池'  then 'IP-赠课失败'
...
when third_department_name = '直播部' and (sku_id_name like '%春春%' or sku_id_name like '%瑞春%') then '陈瑞春'
when third_department_name = '直播部' and sku_id_name like '%朱博士99%' then '朱博士99'
...
when (flow_pool_name like '%汤哥%' or flow_pool_name like '%汤老师%') and period_name not like '%多学科拓展%' and third_department_name='直播部'  then '汤老师'
