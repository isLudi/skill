-- 市场顾问转化看板 SQL
-- 来源：D:\Feishu\0524.txt
-- 更新时间：2026-05-24
-- 最近渠道 CASE 来源：D:\Feishu\0524.txt（基于 0522 新增 周帅-百度数字人、途途私域，B站信息流-亚飞条件补充 rule_name/page_id_name）
with data as
(select distinct
...
(select
    ...
    sum(case when channel_map = '抖音私域' then merge_valid_lead_count else valid_lead_count end)as can_renew_ds_count_a,
...
select  zz.*,
case when rule_name like '2026年-%' then split_part(rule_name, '-', 2)
