...
-- 来源：平台数据集最新查询
-- 更新时间：2026-05-24
-- 范围：H业务线下 市场部、精品班学部、青橙项目部、菁英班学部 的渠道-规则-年级-部门级转化汇总
-- 首call口径：gaotu_crm_offline_statistics.app_mcrm_first_call_task_hf + finance_dw.dim_finance_employee_df 桥接
with data_base as (
    select distinct
        t1.*,
        concat(
