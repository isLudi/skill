...
email_prefix,
path_name,
array_join(slice(split(path_name, '-'), 1, 4), '-') as dep_path, 
name,
talent_type_name,
position_name,
source_hr_status,
...
zz.xiaozu,zz.jingli,zz.department,grade_list,-------------------------新增年级字段
...
group by rd.qici,course_first_level_department_name,course_second_level_department_name,name,user_id1,trade_status,zz.xiaozu,zz.jingli,zz.department,grade_list)
---------------------------------
,wa as (select *,
