...
- `market_consultant_conversion.md`：市场顾问转化看板，来源 `resources/raw_sql/data_center_market_2253_20260704.sql`。
...
- `market_channel_conversion_profile.md`：市场渠道用户画像分析，来源 `market_channel_conversion_profile_call_duration_dataset.sql`、`market_channel_conversion_profile_learn_duration_dataset.sql`、`market_channel_conversion_profile_deep_stage_dataset.sql`、`market_channel_conversion_profile_overall_dataset_fixed.sql`、`refund_rate_multidim.sql`；覆盖首 call 通时、上课时长、深沟阶段、整体画像和多维退费率数据集。
