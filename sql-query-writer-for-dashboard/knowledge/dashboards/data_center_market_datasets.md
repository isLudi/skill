...
|---:|---|---|---|---|---|---|---|---:|
| 1 | `转化数据_市场顾问` | `menu_set_3767103007846227968` | `2253` | `2242` | `menu_source_817034371567951872` | 通用/SQL数据集/H业务线/市场部/市场顾问部/市场顾问部/转化数据_市场顾问 | [data_center_market_2253_20260628.sql](../../resources/raw_sql/data_center_market_2253_20260628.sql) | 413 |
