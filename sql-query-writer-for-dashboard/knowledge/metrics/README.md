...
- `market_consultant_dashboard_metric_formula_linkage.md`：2026-07-05 从市场顾问数据文件夹看板编辑页抽取的前端指标公式、透视表维度、看板组件和数据中心 SQL 的联动索引；用于把看板指标说明关联到唯一 `data_center_market_*_20260705.sql`。
