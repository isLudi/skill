...
| 字段名 | 类型 | 推荐取值 | 是否必填 | 说明 |
|---|---|---|---|---|
| first_level_department_name | string | '<一级部门名称>' | 是 | 组织架构一级部门范围 |
| second_level_department_name | string | '<二级部门名称>' | 是 | 组织架构二级部门范围 |
| third_level_department_name | string | '<三级部门名称>' | 是 | 组织架构三级部门范围 |
...
| first_level_department_name | string | '<一级部门名称>' | 范围限定 | 是 |
| first_level_department_code | bigint | 组织架构一级部门编码 | 关联键 | 否 |
| second_level_department_name | string | '<二级部门名称>' | 范围限定 | 是 |
| second_level_department_code | bigint | 组织架构二级部门编码 | 关联键 | 否 |
| third_level_department_name | string | '<三级部门名称>' | 范围限定 | 是 |
...
- `t.is_main_job = 1`
- `t.is_on_job = 1`
- `t.first_level_department_name = '<一级部门名称>'`
...
where t.dt = 'YYYYMMDD'
  and t.first_level_department_name = '<一级部门名称>'
  and t.is_main_job = 1
limit 20;
```
