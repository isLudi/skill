...
- profile 时间：2026-06-12 16:50:25
- 原始结构 profile：`C:\Users\Ludim\.codex\runtime\usql-web-query-operator\artifacts\20260612-164827\市场顾问数据\外呼过程数据看板\profile.json`
- 页面渲染：成功
...
| 总体数据 | unit_3730781607175761920 | u_pivot | 2054 (内部渠道)外呼过程数据 | page=100<br>download=1 | data_ready | task=1396377820,1396377819<br>rows=4<br>total=4 |
| 主管维度 | unit_3798743671868997638 | u_pivot | 2054 (内部渠道)外呼过程数据 | page=200<br>download=0 | data_ready | task=1396377848,1396377846<br>rows=86<br>total=86 |
| 个人维度 | unit_3798745287165575173 | u_pivot | 2054 (内部渠道)外呼过程数据 | page=200<br>download=0 | data_ready | task=1396377894,1396377892<br>rows=200<br>total=224 |
...
- 刷新：data_ready；task_ids：`1396377820,1396377819`；行数：4；序列：0 / 0 点

### 主管维度

- unit_id：`unit_3798743671868997638`；类型：`u_pivot`；模型：`2054` / (内部渠道)外呼过程数据
- 刷新：data_ready；task_ids：`1396377848,1396377846`；行数：86；序列：0 / 0 点

### 个人维度

- unit_id：`unit_3798745287165575173`；类型：`u_pivot`；模型：`2054` / (内部渠道)外呼过程数据
- 刷新：data_ready；task_ids：`1396377894,1396377892`；行数：200；序列：0 / 0 点
