...
- 0904 精确执行 CASE：183 个 `WHEN` 分支，127 个去重渠道输出值；CASE 文件 SHA-256 `8df7e7b422c52ca3a9987588c8804f2c330ec3dc2a0b2f9989c98501d3f942a7`
- 最近共享 CASE 更新日期：2026-09-04；Data Center 定向覆盖继续保留 2026-08-01/02 已确认边界
- 输出字段：`qudao`
