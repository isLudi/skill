...
case
  when lf.rule_name like '%北京直播江苏%' then '北京直播江苏'
  when lf.get_customer_way_name in ('进校直推','线下渠道商') then '河南进校'
  when lf.get_customer_way_name in ('平台自播') and lf.flow_pool_name in ('赢战广东中考','高途专版图书','状元帮教辅') then '广东图书'
  ...
  when lf.third_department_name = '私域运营部' and lf.source_manager_name in ('陈雷19','崔慧敏01','侯佳林01','郑天琪02','杨彬屹','曹义鹏','王硕阳','于超研','岳一帆02','田起帆','王绍阳','肖佳兴','姚佳03') then '进校私域合作'
  ...
  when (lf.flow_pool_name like '%朱博士%' or lf.flow_pool_name like '%双博士%' or lf.flow_pool_name like '%教育规划%') and lf.third_department_name <> '线上商务部' and lf_period_name not like '%多学科拓展%' and lf.rule_name not like '%张杰%' and lf.sku_id_name not like '%马凯鹏IP%' and lf.third_department_name='直播部' then '朱博士29'
  when lf.put_plan_name like '%朱博士说教育%' and lf_period_name not like '%多学科拓展%' and lf.flow_pool_name not like '%高分讲堂%' and  lf.flow_pool_name not like '%总裁%' and lf.third_department_name='直播部' then '朱博士29'
  when (lf.flow_pool_name like '%朱博士讲英语%' or lf.flow_pool_name like '%朱博士英语%' or lf.flow_pool_name like '%朱汉祺说英语%' or lf.flow_pool_name like '%朱博士说英语%' or lf.flow_pool_name like '%教育规划%' or lf.flow_pool_name like '%双博士英语规划%' or lf.flow_pool_name like '%朱博士满分英语%' or lf.flow_pool_name like '%英语教父朱博士%' or (lf.flow_pool_name like '%中考决胜天团%' and lf.lead_purchase_intention_level1_category_name = '规划系统')) and lf.third_department_name = '直播部' and lf_period_name not like '%多学科拓展%' and lf.sku_id_name not like '%马凯鹏IP%' and lf.third_department_name='直播部' then '朱博士29'
  when (lf.flow_pool_name like '%汤哥%' or lf.flow_pool_name like '%汤老师%') and lf_period_name not like '%多学科拓展%' and lf.third_department_name in ('直播部','新媒体内容运营部') then '汤老师'
  when (lf.flow_pool_name like '%中考百日冲刺%') and lf_period_name not like '%多学科拓展%' and lf.third_department_name='直播部' then '曹忆9.9纯课'
  when lf.source_manager_name = '陈晓菁04' and lf.channel_provider_name not like '%开拓%' and lf.put_plan_name not like '%九学%' then '商务低价'
  when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%' or lf.flow_pool_name like '%孟帝数学%' or lf.flow_pool_name like '%亚飞秒解思维%')  and lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.channel_name_2 = '抖音' then '孟亚飞-1组-抖音'
  when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%' or lf.flow_pool_name like '%孟帝数学%')  and lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.channel_name_2 = '视频号' then '孟亚飞-1组-视频号'
  when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%' or lf.flow_pool_name like '%孟帝数学%')  and lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.channel_name_2 = 'B站' then '孟亚飞-1组-B站'
  when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%' or lf.flow_pool_name like '%孟帝数学%')  and lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.channel_name_2 not like '%百度%' then '孟亚飞99-1组'
  when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%')  and lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' and lf.channel_name_2 = '百度' then '孟亚飞-1组-百度'
  when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%')  and lf_period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部' then '孟亚飞9元'
  ...
  when lf.flow_pool_name like '%峥峥%' and lf_period_name not like '%多学科拓展%' and lf.third_department_name='直播部' then '何峥峥'
  when lf.flow_pool_name like '%汐子%' and lf_period_name not like '%多学科拓展%' and lf.sku_id_name not like '%亚飞%' and lf.third_department_name='直播部' then '王汐子'
  when lf.flow_pool_name like '%汐子%' and lf_period_name not like '%多学科拓展%' and lf.sku_id_name  like '%亚飞%' and lf.third_department_name='直播部' and lf.rule_name like '%99%' then '孟亚飞99-1组'
  when lf.flow_pool_name like '%汐子%' and lf_period_name not like '%多学科拓展%' and lf.sku_id_name  like '%亚飞%' and lf.third_department_name='直播部' then '孟亚飞9元'
  when (lf.flow_pool_name like '%曹忆%' or lf.flow_pool_name like '%dudu%' or lf.flow_pool_name like '%中考决胜天团%' or lf.flow_pool_name like '%具象思维%' or lf.flow_pool_name like '%在逃发面馒头%' or lf.flow_pool_name like '%库洛米%' and lf.lead_purchase_intention_level1_category_name <> '规划系统') and lf_period_name not like '%多学科拓展%' and lf.third_department_name in ('直播部','新媒体内容运营部') then '曹忆'
  ...
  when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪','曹蕊07') and lf_period_name not like '%多学科拓展%' and (lf.flow_original_order_activity_price like '%1100%' or lf.flow_original_order_activity_price like '%500%' or lf.flow_orders_income_amount like '%500%') and (lf.sku_id_name like '%朱汉祺%' or lf.sku_id_name like '%朱博士%' or lf.rule_name like '%朱汉祺5元%' or lf.sku_id_name like '%koc5元-朱博士%' or lf.rule_name like '%朱汉祺%') then 'KOC-5元朱汉祺'
  when lf.source_manager_name in ('孙晗01','方俊结01','刘亦鹏02','何木玲','杨梓月','张可意03','任颖迪','曹蕊07') and lf_period_name not like '%多学科拓展%' and lf.sku_id_name not like '%朱汉祺%' and lf.sku_id_name not like '%朱博士%' and lf.sku_id_name not like '%周帅%' and lf.sku_id_name not like '%29元%' then 'KOC-5元纯课'
  ...
  when lf.source_manager_name in ('包青青','蔡瑞涵','李文迁','李佳馨44','孙昊17','王洁雅01','王硕北','朱文','贾铭锐','李壮壮04','陈晓菁04','赵艺雅') and lf.channel_name_2 like '%直推%' then '进校直推'
  ...
  when lf_period_name like '%多学科拓展%' and lf.third_department_name like '%私域运营%' then '市场私域入群'
