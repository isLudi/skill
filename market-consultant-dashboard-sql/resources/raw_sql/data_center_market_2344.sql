...
when lf.ad_account_name in ('高途-高中-DYD搜索-QZ49','高途-高中-DYD搜索-XLHD49','高途-高中-DYD搜索-XLHD50','高途-高中-DYD搜索-QZ50') then '搜索1元'
...
when lf.third_department_name = '直播部' and (lf.sku_id_name like '%朱博士99%' or lf.rule_name like '%朱汉祺99%' or lf.rule_name like '%朱博士%' or lf.flow_pool_name like '%朱博士%' or lf.sku_id_name like '%朱博士%') then '朱博士99'
...
when (lf.flow_pool_name like '%孟帝%' or lf.flow_pool_name like '%孟老师%' or lf.flow_pool_name like '%中考数学冲刺%' or lf.flow_pool_name like '%8升9数学%' or lf.flow_pool_name like '%孟亚飞讲数学%' or lf.flow_pool_name like '%中考冲刺%' or lf.flow_pool_name like '%中考满分冲刺%' or lf.flow_pool_name like '%押题王孟亚飞%' or lf.flow_pool_name like '%中考数学大通关%' or lf.flow_pool_name like '%中考数学规划%' or lf.flow_pool_name like '%亚飞数学%')  and lf.period_name not like '%多学科拓展%' and lf.channel_name_2 not like '%KOL%' and lf.third_department_name='直播部'  then '孟亚飞9元'
