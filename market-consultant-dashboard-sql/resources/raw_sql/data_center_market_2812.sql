...
src as (
    select
        ...
        t.lead_create_time,
        coalesce(t.city_level_name, '未知') as city_level_name,
...
channel_totals as (
    select
        ...
        channel_map,
        grade_name,
        sum(lead_count) as total_lead_count_in_period_channel_grade,
        sum(net_income_section) as total_net_income_in_period_channel_grade
    from city_agg
    group by
        period_name,
        channel_map,
...
final_city as (
    select
        ...
        c.lead_count,
        c.valid_lead_count,
        c.pay_user_head_count,
        c.pay_subject_person_count,
        c.net_income_section,
        totals.total_lead_count_in_period_channel_grade,
        totals.total_net_income_in_period_channel_grade
    from city_agg c
    join channel_totals totals
      on c.period_name = totals.period_name
     and c.channel_map = totals.channel_map
     and c.grade_name = totals.grade_name
)
