...
-- 2026-09-16 当前指标口径：抖音私信退前取普通 lead_count、退后取普通 valid_lead_count；上游字段承载随批次切换，20260911 期仅取普通字段可能低估。渠道 CASE 保持 0904 映射，并同步检查加微、外呼、到课派生指标。Data Center 或任务 SUCCESS 只证明执行成功，还须按指定期次+渠道回读看板和承接 Base。
case
