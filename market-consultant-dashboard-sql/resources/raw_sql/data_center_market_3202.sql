...
--   渠道映射       : resources/raw_sql/market_channel_case_when_0612.sql
...
--   dt    : 左闭右开, dt >= ${dt:1} and dt < ${dt:2}
--   hour  : 左闭右开, hour >= ${hour:1} and hour < ${hour:2}
...
--    渠道映射: 使用 market_channel_case_when_0612.sql (175 分支, 107 输出值)
...
select
    ...
    -- 基础聚合指标 (21)
    -- ============================================================
    zz.lead_count                                               as lead_count,
    zz.can_renew_ds_count_a                                     as can_renew_ds_count_a,
    zz.xiansuo                                                  as xiansuo,

    zz.pay_users                                                as pay_users,
    zz.pay_users_on_period                                      as pay_users_on_period,
    zz.pay_users_not_on_period                                  as pay_users_not_on_period,

    zz.pay_user_subs                                            as pay_user_subs,
    zz.pay_user_subs_on_period                                  as pay_user_subs_on_period,
    zz.pay_user_subs_not_on_period                              as pay_user_subs_not_on_period,

    zz.pay_user_subs_joint                                      as pay_user_subs_joint,
    zz.pay_user_subs_joint_onp                                  as pay_user_subs_joint_onp,
    zz.pay_user_subs_joint_nonp                                 as pay_user_subs_joint_nonp,

    zz.trade_income                                             as trade_income,
    zz.trade_refund                                             as trade_refund,
    zz.trade_profit                                             as trade_profit,
    zz.xb_trade_income                                          as xb_trade_income,
    zz.xb_trade_profit                                          as xb_trade_profit,
    zz.kk_trade_income                                          as kk_trade_income,
    zz.pre_refund                                               as pre_refund,

    zz.pp_pmit                                                  as pp_pmit,
    zz.ww_pmit                                                  as ww_pmit,
