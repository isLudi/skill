"""Validate the local Text2SQL skill stack with one read-only command."""
...
REFERENCE_PREFIXES = ("knowledge/", "resources/", "scripts/", "docs/", "references/", "agents/")
BACKTICK_REFERENCE_RE = re.compile(
    r"`((?:knowledge|resources|scripts|docs|references|agents)/[^`\r\n]+)`"
)
