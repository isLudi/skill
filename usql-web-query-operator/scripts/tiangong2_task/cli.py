...
def build_parser() -> argparse.ArgumentParser:
    ...
    plan_query_update = subparsers.add_parser(
        ...
        help="Plan a query_sql-only update for one exact owned Python task without remote writes.",
    )
    ...
    apply_query_update.add_argument("--confirm-save-query", action="store_true", required=True)
    ...
    submit.add_argument("--confirm-submit", action="store_true", required=True)
    submit.add_argument(
        "--artifacts-dir",
        type=Path,
    ...
    execute_once.add_argument("--confirm-execute", action="store_true", required=True)
...
def cmd_apply_task_query_update(args: argparse.Namespace) -> int:
    ...
    authorization = authorize_query_update(
        ...
        confirm_save_query=args.confirm_save_query,
    )
    scope = plan["scope"]
