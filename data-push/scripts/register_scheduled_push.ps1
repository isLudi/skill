...
$pushDescription = 'data-push market KOC robot reports. Prepare 09:15/13:15/17:15/21:15; send :20-:50. Current-week process daily; conversion Fri-Sun; verified manager mentions. Explicit enablement required. Requires Windows login and network.'
