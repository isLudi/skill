...
if ($LASTEXITCODE -ne 0) { throw 'Could not resolve the supervisor KOC grade-9 schedule configuration.' }
...
$pushTaskName = 'Codex-Lark-Supervisor-KOC-Grade9-Push'
$pushLauncher = Join-Path $PSScriptRoot 'run_supervisor_self_incubated_koc_5_grade_9_scheduled_push.ps1'
